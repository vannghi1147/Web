...
?>
<table width="400" border="0" align="left" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
  <tr> 
    <td bgcolor="#FFFFFF"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
	<form name="adminForm" action="" method="POST">
        
        <tr>
          <td align="center" valign="middle"><img src="../images/chgpass.jpg" width="160" /></td>
          <td width="50%" align="left">
            <table width="100%" border="0" cellspacing="0" cellpadding="4">
              <tr>
                <td><strong>Nhập password cũ</strong><br />
                  <input type="password" name="passold" class="inputbox" style="width:180px;" id="passold" tabindex="0"/>
                  </td>
                </tr>
              <tr>
                <td><strong>Password mới</strong><br />
                  <input name="passphp1" type="password" style="width:180px;" id="passphp1" tabindex="1"/></td>
              </tr>
              <tr>
                <td><strong>Xác nhận password mới</strong><br />
