<?php 
	...
	if($xuly){
		...
		$result=users_them($HoTen,$Username,$Password,$DiaChi,$Dienthoai,$Email,$NgaySinh,$GioiTinh,$idGroup);
		if($result){
			echo " <meta http-equiv='refresh' content='0;URL=index.php?p=users'>";
		}		
...
<form action="" method="post" enctype="multipart/form-data" name="form1">
  ...
  <table class="tbl" width="1000" border="0" align="center" cellpadding="1" cellspacing="1">
    ...
    <tr>
      ...
      <td bgcolor="#CCCCCC"><label for="DiaChi"></label>        <label for="GioiTinh2">
        <input type="password" name="Password" id="Username" />
      </label></td>
    </tr>
    <tr>
      <td bgcolor="#CCCCCC" style="text-align: center">Địa chỉ</td>
      <td bgcolor="#CCCCCC"><input type="text" name="DiaChi" id="DiaChi" /></td>
    </tr>
    <tr>
      <td bgcolor="#CCCCCC" style="text-align: center">Điện thoại</td>
      <td bgcolor="#CCCCCC"><input type="text" name="Dienthoai" id="Dienthoai" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td bgcolor="#CCCCCC"><input type="text" name="NgaySinh" id="NgaySinh" /></td>
    </tr>
    <tr>
    ...
    <tr>
      <td width="118" bgcolor="#CCCCCC"><input name="xuly" type="hidden" id="xuly" value="1"></td>
      <td bgcolor="#CCCCCC"><p>
